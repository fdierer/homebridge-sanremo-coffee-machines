...
### Fixed
- Hardened polling JSON parsing for read-only and read-write parameters to avoid runtime errors when the machine returns unexpected responses.
- Polling errors are now logged cleanly without throwing TypeError.
